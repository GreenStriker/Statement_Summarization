...
base_directory = 'E:\\Statement_Summarization\\Using_Data_Mining\\PDF'
if not os.path.isdir(base_directory):
    print("%s is not a directory" % base_directory)
    exit(1)
# Change this to your pdf2htmlEX executable location
bin_path = 'E:\Statement_Summarization\Using_Data_Mining\pdf2htmlEX-win32-0.14.6-upx-with-poppler-data_2\pdf2htmlEX.exe'
