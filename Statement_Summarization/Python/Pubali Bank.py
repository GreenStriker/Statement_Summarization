...
pdf_path = directory_path + "/PDF/PubaliBank.pdf"
...
# open('C:/Statement/DBBL/Text file/dutch.txt', 'w', encoding="utf-8")
...
for x in range(get_pdf_length):
    ...
    with Image(img, resolution=200) as img:
        ...
        # img.save(filename='C:/Statement/DBBL/Images/grayscale.png')
    ...
    # with open("C:/Statement/DBBL/Text file/document.txt", "r", encoding="utf-8") as f:
    with open(directory_path + "/Text file/document.txt", "r", encoding="utf-8") as f:
        for line in f:
            ...
            if ((re.match(r"([A-Za-z0-9_]{1,2}-[A-Za-z0-9_]{1,2}-[\d]{4})", line)) or (
                 re.match(r"([A-Za-z0-9_]{1,3}[A-Za-z0-9_]{1,2}-[\d]{4})", line)) or (
                 re.match(r"([A-Za-z0-9_]{1,2}-[A-Za-z0-9_]{1,2}[\d]{4})", line))):
                # f = open('C:/Statement/DBBL/Text file/dutch.txt', 'a+', encoding="utf-8")
